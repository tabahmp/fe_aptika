...
export default function Header({ title, subtitle, showBrand = false }: HeaderProps) {
  ...
  return (
    <header className="flex items-center justify-between bg-white/60 dark:bg-[#071733]/90 backdrop-blur-md border border-white/70 dark:border-slate-800 rounded-2xl px-6 py-4 shadow-sm select-none relative z-30 transition-colors duration-300 print:hidden">
      {/* Title / Brand Area */}
      {showBrand ? (
        <div
