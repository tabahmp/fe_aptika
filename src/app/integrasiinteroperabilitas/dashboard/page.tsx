      ...
      <div style={S.page}>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: "10px", flexWrap: "wrap", alignItems: "center" }}>
            ...
            <button onClick={() => router.push("/integrasiinteroperabilitas/edit")} style={{ background: "#fef3c7", color: "#92400e", border: "1px solid #fcd34d", padding: "8px 16px", borderRadius: "8px", fontSize: "13px", fontWeight: "600", cursor: "pointer", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>✎ Edit</button>
            <button onClick={() => router.push("/integrasiinteroperabilitas/input")} style={{ background: "linear-gradient(135deg, #0f2540, #1d4ed8)", color: "white", border: "none", padding: "8px 16px", borderRadius: "8px", fontSize: "13px", fontWeight: "600", cursor: "pointer", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>+ Isi Form Rekapitulasi</button>
          </div>
        </div>
